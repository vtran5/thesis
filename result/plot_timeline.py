...
pu.plot_filtered_data(axs[0], filtered_timer, 'Timer1', '--', 'green', frame_id=True)
...
pu.plot_filtered_data(axs[2], filtered_subscriber3, 'Subscriber2', '--', 'magenta', frame_id=True)
...
pu.plot_filtered_data(axs[3], filtered_subscriber4, 'Subscriber3', '--', 'yellow', frame_id=True)
