...
dfs = [input_overhead, output_overhead, input_triggered, output_write, 
       publish_internal_overhead, publish_overhead, total_overhead_input,
...
#        publish_internal_overhead_nolet, publish_overhead_nolet, input_read_nolet, 
dfs_nolet = [input_overhead_nolet, input_triggered_nolet, publish_overhead_nolet, total_overhead_input_nolet,
