...
actual_timer1 = ActualTimer(-11, 200)
actual_timer2 = ActualTimer(-11, 420)
actual_timer3 = ActualTimer(-1, 160)

timer1 = Task("Timer1", "Timer", 8, 1, actual_timer1)
timer2 = Task("Timer2", "Timer", 8, 2, actual_timer2)
timer3 = Task("Timer3", "Timer", 70, 3, actual_timer3)

subscriber1 = Task("Subscriber1", "Subscriber", 70, 5)
subscriber2 = Task("Subscriber2", "Subscriber", 70, 6)
subscriber3 = Task("Subscriber3", "Subscriber", 160, 7)
subscriber4 = Task("Subscriber4", "Subscriber", 160, 8)
subscriber5 = Task("Subscriber5", "Subscriber", 160, 9)
subscriber6 = Task("Subscriber6", "Subscriber", 160, 10)
...
test_events = simulate_threads([thread1, thread2, thread3, thread4], 150000)
print("StartTime", 0)
#print(test_events)
