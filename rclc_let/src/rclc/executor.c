...
//  printf("Output index %ld, num_period_per_let %d\n", executor->handles[handle_index].callback_info->output_index,executor->handles[handle_index].callback_info->num_period_per_let);
